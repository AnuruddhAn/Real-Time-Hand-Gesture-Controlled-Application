...
def main():
    ...
    <h1 style="color:white;text-align:center;">Real-Time-Hand-Gesture-Controlled-Application</h1>
    </div>
    """
    st.markdown(html_temp, unsafe_allow_html=True)

    st.sidebar.title("Pages")
    # Add a selectbox to the sidebar:,'Project Demo'
...
<li>Ankit Gupta </li>
    ...
    if add_pages=='About Web App':
        html_temp2 = """
    <body style="background-color:white;padding:10px;color:blue;">
...
"""
    ...
    #     st.video("D:\\Minor Project\\media\\demo.mp4")
        ...
        html_temp5 = """
    <body style="background-color:white;padding:5px;">
    <h3 style="color:black ;text-align:center;">Real-Time-Hand-Gesture-Controlled-Application</h3>
        <ul style="color:blue;"> Gestures and their Function
